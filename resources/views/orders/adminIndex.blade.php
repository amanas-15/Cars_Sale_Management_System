                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if ($order->status == 'incomplete')
                                                            <a href="{{ route('agreement-index', ['id' => $order->id]) }}"
                                                                id="{{ $order->id }}"
                                                        ...
                                                        @else
                                                            <button type="button"
                                                                class="btn  btn-sm btn-s rounded-pill btn-icon btn-success">
                                                                <span class="tf-icons fa-solid fa-check"></span>
                                                            </button>
                                                        @endif
...
@section('scripts')
    ...
    <style>
        ...
        body{
            background-image: linear-gradient(rgba(0,0,0,0.2),rgba(0,0,0,0.2)), url("lambohurankan.jpeg");
